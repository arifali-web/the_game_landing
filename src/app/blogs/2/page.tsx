...
import TableIndex from '@/component/partials/table/table'
                ...
                <div className='row px-lg-5 px-2 blog3-text'>
                    ...
                    <div className="col-lg-6 col-12 text-start">
                        ...
                        <div className='row'>
                            ...
                            <div className="col-6">
                                {/* <Image src={'/landingpage-images/black-arrow.svg'} style={{ width: '100%', height: '100%' }} alt='' height={250.71} width={730.09} /> */}
                            </div>
                        </div>
                    </div>
