                ...
                <div className='blog2 text-center'>
                    ...
                    <div className='row px-lg-5 px-2 mt-5'>
                        <div className="col-lg-6 col-12 text-start">
                            <Image style={{ position: 'relative', top: '80px', left: '90px' }} src={'/landingpage-images/heart1.svg'} width={76.55} height={100.36} alt={''} />
                            <BlogText
                                heading={
                                    <h2 className='heading'>
                                        <span className='sub-heading'>There is no</span><br />
                                        perfect <br />
                                        <span className='sub-heading d-flex justify-content-end pb-0'>match</span>
                                    </h2>
                                }
                                subHeading=''
                                ...
                                number={1}
                                src={'/landingpage-images/arrow-5.svg'}
                            />
                            <List text='' litext={BeYou} />

                        </div>
                        <div className="col-lg-6 col-12 right text-start">
                            <Image style={{ position: 'relative', top: '120px', left: '260px' }} src={'/landingpage-images/heart2.svg'} width={76.55} height={100.36} alt={''} />
                            <BlogText
                                heading={
                                    <h2 className='heading'>
                                        <span className='sub-heading'>Have your</span><br />
                                        priorities <br />
                                        <span className='sub-heading d-flex justify-content-end pb-0'>straight</span>
                                    </h2>
                                }
                                subHeading=''
                                src={'/landingpage-images/arrow-5.svg'}
                ...
                <div className='row '>
                    <div className="col-lg-6 col-12 left text-start">
                        <BlogText
                            ...
                            number={3}
                        />
                        {/* <Image style={{ position: 'relative', top: '0px', left: '0px' }} src={'/landingpage-images/heart3.svg'} width={81.72} height={98.56} alt={''} /> */}
                    </div>
                    <div className="col-lg-6 col-12 right text-start">
                        <BlogText
                            heading='Mindset'
