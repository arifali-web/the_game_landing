    ...
    <LandingpageLayout>
      <div className='px-lg-5 px-2 bg'>
        ...
        <p>Date: <span style={{ color: '#EC1D1D', paddingLeft: '5px' }}>2-2-2024</span><br /><br />Welcome to &ldquo;The Game App&rdquo;!<br /><br />We&rsquo;re glad You&rsquo;re here, and
          ...
          other Users, the amount of personal information You share is at Your own risk.<br /><br /> <h2 className='rebond-bold'>1. Type of Personal
            Data We Collect</h2><br /><br />When You visit the Website or use Our Services, We may collect personal information
          ...
          Privacy Act (CCPA):<br /><br /><h3 className='rebond-bold'>Registration Information</h3><br /><br />When You create an Account, we may collect
          ...
          account ownership, IBAN number and Your Swift Code for the paid version of the Game App.<br /><h3 className='rebond-bold '>Unregistered
            Users</h3><br /><br />If You are a passive user of the App and do not register for any purchases or other service,
          ...
          and certain br/owser data, such as history and/or session information.<br /><br /><h3 className='rebond-bold '>Purchases Information</h3><br /><br />If
          ...
          their transaction cannot be processed.<br /><br /><h3 className='rebond-bold '>Geolocation Information</h3><br />If You have given The Game App
          ...
          consent. You can report if the opposite occurs.<br /><br /><h3 className='rebond-bold '>Device and Photos Information</h3><br /><br />We may collect
          ...
          settings.<br /><br /><h3 className='rebond-bold '>Links</h3><br /><br />We may keep track of how You interact with links available on The Game App
          including third party services by redirecting clicks or through other means. We may share aggregate click
          statistics such as how many times a particular link was clicked on.<br /><br /><h3 className='rebond-bold '>Other Collected
            Information</h3><br /><br />We may collect data other than the ones mentioned in these Privacy Policy such as Your
          hobbies, country of origin, country of residence, height, weight, hair color, eye color, favorite cuisine,
          diet, relationship status, religious beliefs, geolocation data, metadata, etc.<br /><br /><h2 className='rebond-bold '>2. Cookies and Similar
            Technologies</h2><br /><br />(a) Like most online services and websites, We may use Cookies and other technologies,
          ...
          websites.&nbsp;<br /><br /><h2 className='rebond-bold '>3. Use of Information</h2><br /><br />We use the information discussed above in a number of
          ...
          contacting Us at support@thegameapp.io.<br /><br /><h2 className='rebond-bold '>4. Sharing of Your Information</h2><br /><br />We will not rent or sell
          Your information to third parties outside The Game App without Your consent, except as noted in this Privacy
          Policy.&nbsp;<br /><br /><h3 className='rebond-bold '>Parties with whom We may share Your information:</h3><br /><br />(a) With Our corporate entities
          ...
          data for industry analysis and demographic profiling.<br /><br /><h3 className='rebond-bold '>Responding to legal requests and preventing
            harm:</h3><br /><br />We may access, preserve and share Your information in response to a legal request if We have a
          ...
          violations of Our terms or policies, or otherwise to prevent harm.<br /><h2 className='rebond-bold'>5. Storage and Processing</h2><br />Your
          ...
          emails between You and The Game App, at all times. &nbsp;<br /><h3 className='rebond-bold'>Service Providers</h3><br /><br />We engage certain
          ...
          limits.<br /><br /><h3 className='rebond-bold'>Marketing Services Providers</h3><br /><br />We partner with providers of marketing services (such as
          ...
          this to inform advertising related services provided to other clients.<br /><br /><h2 className='rebond-bold'>Your rights related to Your
            Personal Data</h2><br /><br />6.1. You have the right to:&nbsp;<br /><br />Request access to Your Personal Data. This
          ...
          policies.<br /><br /><h2 className='rebond-bold'>8. Children Privacy</h2><br /><br />The Game App does not knowingly collect or solicit any information
          from anyone under the age of 18 or knowingly allow such persons to register for the Services. The Services
          and its content are not directed at children under the age of 18.<br /><br /> <h2 className='rebond-bold'>9. Confidentiality and Security of
            Personal Data</h2><br /><br />Except as otherwise provided in this Privacy Policy We will keep Your Personal Data
          ...
          the following email support@thegameapp.io.</p><br /><h2 className='rebond-bold text-white'>10. Other Websites and Services.</h2><br /><p>
          We are not responsible for the practices employed by any websites or services linked to or from Our Services, including the information or content contained within them. Please remember that when You use a link to go from Our Services to another website or service, Our Privacy Policy does not apply to those third-party websites or services. Your browsing and interaction on any third-party website or service, including those that have a link on Our website, are subject to that third party's own rules and policies. In addition, You agree that We are not responsible and do not have control over any third-parties that You authorize to access Your Account. If You are using a third-party website or service and You allow them to access Your Account, You do so at Your own risk.
        </p><br /><h2 className='rebond-bold text-white'>11. Limitation to Our Privacy Policy</h2><br />
